...
//size
while (ptr1 != NULL) //ptr->next doesn't print last one. O I see. last one is pointing to null. so ptr becomes null!
    {
        ptr1 = ptr1->next;
        count++;
    }
...
{
int x=count;
while(x>2)//x-1 was leading to segment dumped error.
{
ptr2=ptr2->next;
x--;
}
