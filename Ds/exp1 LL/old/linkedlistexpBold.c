...
struct Node *Start[10]; //should I dynamically allocate? or I just need these many...
...
void split()
{
    ...
    prev->next = NULL;
    Start[x + 1] = ptr;
    printf("Id of the 2 lists: %d, %d", x, x + 1);
}
...
void maxmin()
{
    ...
    if (minpos != 1 && minpos != count) //if max elemnt is first or last the program stops. need to check
    {
