...
enum type_of_record {EMPTY, DELETED,OCCUPIED}; // constants
...
struct Record // to make table
{
	struct employee info; // actual data
	enum type_of_record status; // check if empty or not
};	
