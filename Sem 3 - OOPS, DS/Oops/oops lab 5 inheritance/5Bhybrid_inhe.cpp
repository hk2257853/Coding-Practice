...
/*
virtual inheritance to address the Diamond Problem:
"virtual" keyword ensured that there's a single instance of the common base class (student) shared 
between the derived classes (test1 and test2). Thus avoiding conflicts and confusion (when using result class).
*/