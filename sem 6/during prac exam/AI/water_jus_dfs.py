def water_jug_dfs(jug1_capacity, jug2_capacity, target):
    ...
    while stack:
        ...
        if jug1 < jug1_capacity and not visited[jug1_capacity][jug2]:
            ...
            stack.append((jug1_capacity, jug2, new_path))
        ...
        if jug1 > 0 and jug2 < jug2_capacity:
            ...
            if not visited[jug1 - amount][jug2 + amount]:
                ...
                stack.append((jug1 - amount, jug2 + amount, new_path))
...
# -------main-----------------
# Test the water_jug_dfs function
